...
(function () {
        ...
        document.querySelector('#span_home').onclick = function () {
            getData('http://192.168.2.31:8080/api/home/center', null, {"token": token}, function (res) {
        ...
        document.querySelector('#share_video').onclick = function () {
            getData('http://192.168.2.31:8080/api/home/center', null, {"token": token}, function (res) {
                if (res && res.status_code == '10008') {
                    location.href = '../html/life_style.html'
                } else if (res && res.status_code == '10006') {
                    alert(res.status_text);
                    location.href = '../html/login.html'
                } else {
        ...
        var search_value=document.querySelector('.form-group input');
        document.querySelector("#btn").onclick=function () {
            if (search_value.value){
                sessionStorage.setItem('value',search_value.value);
