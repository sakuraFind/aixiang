...
function addOption() {
    for (var i = 0; i < 100; i++) {
        document.getElementById("year").options[i] = new Option(2019 - i, 2019 - i);
    }
...
function addProvince() {
    ...
    var provs = ["北京市", "天津市", "上海市", "重庆市", "河北省", "山西省", "内蒙古", "辽宁省", "吉林省", "黑龙江省", "江苏省", "浙江省", "安徽省", "福建省", "江西省", "山东省", "河南省", "湖北省", "湖南省", "广东省", "广西省", "海南省", "四川省", "贵州省", "云南省", "西藏", "陕西省", "甘肃省", "青海省", "宁夏", "新疆", "香港", "澳门", "台湾省"];
    prov.length = 0;
...
function addCity() {
    ...
    var cities = [
        ...
        ["和平区", "河东区", "河西区", "南开区", "河北区", "红桥区", "塘沽区", "汉沽区", "大港区", "东丽区", "西青区", "津南区", "北辰区", "武清区", "宝坻区", "蓟县", "宁河县", "芦台镇", "静海县"],
        ...
        ["广州市", "深圳市", "清远市", "韶关市", "河源市", "梅州市", "潮州市", "汕头市", "揭阳市", "汕尾市", "惠州市", "东莞市", "珠海市", "中山市", "江门市", "佛山市", "肇庆市", "云浮市", "阳江市", "茂名市"],
    ...
    for (var i = 0; i < titles.length; i++) {
        ...
        titles[i].onclick = function () {
            ...
            for (var j = 0; j < titles.length; j++) {
                ...
                titles[j].style.backgroundColor = 'rgba(204, 204, 204, 0.21)';
            }
            //给当前悬浮元素添加属性
            titles[this.id].className = "select";
            divs[this.id].style.display = "block";
            titles[this.id].style.backgroundColor = "white"
        }
    }
}
...
// 拿到基本信息中的信息的js
// var headimg = document.querySelector('#oDiv img');
...
//     var obj = document.querySelectorAll("#gender input");
//     alert(obj[0].value);
...
//     }
// };
var user_info = {'sex': "sex", 'nickname': username,};
// postData('127.0.0.1', user_info, function (res) {
//     console.log(res)
// });
// // alert(test())
...
// // 获邮箱界面的信息
var email_id = document.querySelector('#div02 .tab01 table tr .div-01').value;
// var email_pw = document.querySelector('#div02 .tab01 table tr .div-02').value;
// var email_info = {'email': email_id, 'password': email_pw};
var email_button = document.getElementById('btn01');
//
// postData('127.0.0.1', email_info, function (res) {
//     console.log(res)
// });
...
email_button.onchange = function () {
    checkEmail();
    alert('1')
};